...
namespace Game.Scripts.UI
{
    public sealed class BusinessView : MonoBehaviour
    {
        ...
        [SerializeField] private Text _levelUpPriceText;
        [SerializeField] private Button _up1Btn;
        [SerializeField] private Text _up1PriceText;
        [SerializeField] private Button _up2Btn;
        [SerializeField] private Text _up2PriceText;
        ...
        public void Init(EcsWorld world, int entity, GameCatalogSO catalog)
        {
            ...
            _nameText.text = _catalog.Names.BusinessNames[_id.Get(_entity).Id];
        }
        ...
        private void Update()
        {
            ...
            if (float.IsNaN(_prevIncome) || Mathf.Abs(income - _prevIncome) > 0)
            {
                ...
                else
                {
                    ...
                    _incomeText.text = $"Доход: {baseIncome}$";
                }
            }
            ...
            {
                _up1PriceText.text = $"{_catalog.Names.Upgrade1Names[_id.Get(_entity).Id]}\n" +
                                     $"Доход: +{config.Upgrade1Multiplier}%\n" +
